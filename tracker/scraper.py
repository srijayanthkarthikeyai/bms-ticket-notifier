...
def check_bms_availability(
    ...
    try:
        ...
        # Check for date redirect drop (BMS redirects unreleased dates to general pages)
        ...
        # Booking is confirmed open when time slots appear in conjunction with booking elements
